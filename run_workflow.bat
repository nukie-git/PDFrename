...
:: Get target directory from command argument %1, default to current directory "."
set "TARGET_DIR=."
...
:: Dependencies exist, run renaming preview directly
echo.
:: set /p run_choice="Would you like to run the rename workflow preview (dry run)? (Y/N): "
